			...
			async with _package_lock:
				if _package_ref is ...:
					...
					parameterization = resource_pb2.Parameterization(
						name="demo_network",
						version=get_version(),
						value=base64.b64decode("ewogICJtb2R1bGUiOiAiZ2l0aHViLmNvbS9wdWx1bWktZGVtb3MveXRlLWFzc3VyYW50LWRlbW8vL2RlbW8tbmV0d29yay1tb2R1bGUiLAogICJwYWNrYWdlTmFtZSI6ICJkZW1vX25ldHdvcmsiCn0="),
					)
