...
@pulumi.type_token("demo_network:index:Module")
class Module(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["aks_subnet_id"] = None
            __props__.__dict__["postgresql_dns_zone_id"] = None
            __props__.__dict__["postgresql_subnet_id"] = None
            __props__.__dict__["resource_group_name"] = None
            __props__.__dict__["vnet_id"] = None
        super(Module, __self__).__init__(
            'demo_network:index:Module',
            resource_name,
            __props__,
            opts,
    ...
    @_builtins.property
    @pulumi.getter
    def aks_subnet_id(self) -> pulumi.Output[Optional[Any]]:
        return pulumi.get(self, "aks_subnet_id")

    @_builtins.property
    @pulumi.getter
    def location(self) -> pulumi.Output[Optional[Any]]:
        return pulumi.get(self, "location")

    @_builtins.property
    @pulumi.getter
    def postgresql_dns_zone_id(self) -> pulumi.Output[Optional[Any]]:
        return pulumi.get(self, "postgresql_dns_zone_id")

    @_builtins.property
    @pulumi.getter
    def postgresql_subnet_id(self) -> pulumi.Output[Optional[Any]]:
        return pulumi.get(self, "postgresql_subnet_id")

    @_builtins.property
    @pulumi.getter
    def resource_group_name(self) -> pulumi.Output[Optional[Any]]:
        return pulumi.get(self, "resource_group_name")

    @_builtins.property
    @pulumi.getter
    def vnet_id(self) -> pulumi.Output[Optional[Any]]:
