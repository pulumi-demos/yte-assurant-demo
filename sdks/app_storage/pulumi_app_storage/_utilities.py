			...
			async with _package_lock:
				if _package_ref is ...:
					...
					parameterization = resource_pb2.Parameterization(
						name="app_storage",
						version=get_version(),
						value=base64.b64decode("ewogICJtb2R1bGUiOiAiZ2l0aHViLmNvbS9wdWx1bWktZGVtb3MveXRlLWFzc3VyYW50LWRlbW8vL2FwcC1zdG9yYWdlLW1vZHVsZT9yZWY9bWFpbiIsCiAgInBhY2thZ2VOYW1lIjogImFwcF9zdG9yYWdlIgp9"),
					)
